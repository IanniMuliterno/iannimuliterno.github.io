...
LR não é o mais amigável dos métodos, mas graças a softwares como o R não é necessário implementar o teste, apenas compreender o que acontece por trás dele.


 Sim, explicar à fundo o LR é um pouco tricky, precisaríamos ainda chafurdar um pouco em teste de hipótese, em entender o básico da distribuição qui-quadrado e saber o que acontece no cálculo da máxima verossimilhança. Para quem não quer se aventurar na teoria e não está tão preocupado com o custo computacional, a forma mais simpática de resolver o dilema que da nome ao post é usar Cross-Validation. Se não é o seu caso, aguarde os próximos posts.
